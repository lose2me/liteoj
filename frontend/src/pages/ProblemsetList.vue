...
const renderJoin = (r: any) => {
  if (r.is_banned) {
    return h(
      NTag,
      { type: "error", size: "small" },
      { default: () => t.problemset.bannedTag },
    );
  }
  if (r.is_member) {
    return h(
    ...
    render: (r: any) =>
      r.top_ac_name
        ? h(
            ...
            t.problemset.topWith(r.top_ac_name, r.top_ac_count),
          )
        : h("span", { class: "opacity-40" }, t.common.empty),
  },
  {
    ...
    width: 140,
    render: (r: any) =>
      h("span", { style: "white-space:nowrap" }, fmt(r.start_time)),
  },
  {
    ...
    width: 140,
    render: (r: any) =>
      h("span", { style: "white-space:nowrap" }, fmt(r.end_time)),
  },
