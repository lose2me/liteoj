...
const routes = [
  {
    ...
    children: [
      ...
      { path: "problems", redirect: "/problemsets" },
      {
        path: "problems/:id",
        component: () => import("../pages/ProblemDetail.vue"),
        meta: { wide: true },
      },
      { path: "submissions", redirect: "/me" },
      {
        path: "submissions/:id",
      ...
      {
        path: "problemsets",
        component: () => import("../pages/ProblemsetList.vue"),
      },
      {
        path: "problemsets/:id",
        component: () => import("../pages/ProblemsetDetail.vue"),
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "problems",
        component: () => import("../pages/admin/Problems.vue"),
      },
      {
        path: "problems/:id",
        component: () => import("../pages/admin/ProblemEdit.vue"),
      },
      {
        path: "problemsets",
        component: () => import("../pages/admin/Problemsets.vue"),
      },
      {
        path: "settings",
