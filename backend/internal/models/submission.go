...
type Submission struct {
	...
	UserID             uint      `gorm:"index;index:idx_user_created,priority:1;not null" json:"user_id"`
	ProblemID          uint      `gorm:"index;index:idx_problem_user,priority:1;not null" json:"problem_id"`
	ProblemSetID       *uint     `gorm:"index" json:"problemset_id,omitempty"`
	...
	CreatedAt       time.Time `gorm:"index;index:idx_user_created,priority:2" json:"created_at"`
}
